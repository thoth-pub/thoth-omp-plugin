...
de la Lista 27 de ONIX (`03`, `10`, `12` o `93`) o un prefijo equivalente. También se admiten los valores
estructurados `source` e `identifier` de OMP. Los valores que no se pueden confirmar o que corresponden a más de
un esquema se sincronizan como `Keyword`.
