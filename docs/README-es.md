...
[![Versión Actual](https://img.shields.io/github/v/release/thoth-pub/thoth-omp-plugin?filter=v0.2.%2A&sort=semver&label=versi%C3%B3n&color=blue)](https://github.com/thoth-pub/thoth-omp-plugin/releases)
